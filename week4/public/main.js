...
var Editor1Component = /** @class */ (function () {
    function Editor1Component(collaboration, route, dataService) {
    ...
    Editor1Component.prototype.submit = function () {
        var _this = this;
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.getProblems = function () {
        ...
        this.http.get("api/v1/problems")
            .subscribe({
            next: function (res) { return _this.problemSource.next(res); },
...
module.exports = __webpack_require__(/*! /home/ruji/Workspaces/Collaborative Online Judge System/week4/oj-client/src/main.ts */"./src/main.ts");
